...
describe('CartController', () => {
    ...
    it('should cart Entity in insertProductInCart', async () => {
        const cart = await cartController.createCart(insertCartMock, userEntityMock.id);
    ...
    it('should delete a product from cart', async () => {
        const cart = await cartController.deleteProductCart(productMock.id, userEntityMock.id);
